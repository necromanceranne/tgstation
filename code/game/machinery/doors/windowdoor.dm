/obj/machinery/door/window
	...
	var/base_state = "left"
	max_integrity = 100 //If you change this, consider changing ../door/window/brigdoor/ max_integrity at the bottom of this .dm file
	integrity_failure = 0
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 10, BIO = 0, FIRE = 70, ACID = 100)
	visible = FALSE
	damage_deflection = 0
	flags_1 = ON_BORDER_1
	opacity = FALSE

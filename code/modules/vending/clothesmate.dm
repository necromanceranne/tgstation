	...
	product_categories = list(
		...
		list(
			...
			"products" = list(
				...
				/obj/item/clothing/under/rank/civilian/purple_bartender = 3,
				/obj/item/clothing/suit/jacket/miljacket = 3,
				/obj/item/clothing/suit/apron/overalls = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/graphic = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/graphic/ian = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/wornout = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/wornout/graphic = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/wornout/graphic/ian = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/messy = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/messy/graphic = 3,
				/obj/item/clothing/suit/costume/wellworn_shirt/messy/graphic/ian = 3,
			),
		),
